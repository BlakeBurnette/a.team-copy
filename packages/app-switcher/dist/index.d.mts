import { HiveApp } from '@payhive/sso-client';
export { HiveApp } from '@payhive/sso-client';
 ...
 */
type OnSwitchApp = (app: HiveApp) => Promise<SwitchResult>;
/**
 ...
 */
declare function useAppSwitcher(options: UseAppSwitcherOptions): UseAppSwitcherState;
 ...
 * ```
 */
declare function AppSwitcher({ currentApp, allowedApps, isAdmin, onSwitchApp, identityUrl, accentColor, className, }: AppSwitcherProps): react_jsx_runtime.JSX.Element | null;

export { AppSwitcher, type AppSwitcherProps, type OnSwitchApp, type SwitchResult, type UseAppSwitcherOptions, type UseAppSwitcherState, AppSwitcher as default, useAppSwitcher };
